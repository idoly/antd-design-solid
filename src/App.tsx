          ...
          <div class="mx-auto max-w-7xl space-y-8">
            ...
            <section id="overview" class="scroll-mt-4 space-y-4">
              ...
              <div class="grid border-y border-border-secondary bg-surface sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div class="border-b border-border-secondary p-5 lg:border-b-0 lg:border-r"><Statistic title="Automated tests" value={274} suffix="passing" /></div>
            ...
            <section id="display" class="scroll-mt-4 space-y-4">
              ...
              <div class="grid gap-5 xl:grid-cols-2">
                <Card title="Release details">
                  ...
                  <Timeline items={[{ children: 'Build completed', color: 'green' }, { children: '274 tests passed', color: 'green' }, { children: 'Package verified', color: 'blue' }]} pending="Awaiting publish" />
                </Card>
