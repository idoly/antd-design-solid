              ...
              <div class="grid gap-5 lg:grid-cols-3">
                ...
                <Card title="Release code">
                  <div class="flex flex-col items-center gap-3">
                    <QRCode type="svg" value="https://example.com/releases/0.2.1" />
                    <Typography.Text copyable>release/0.2.1</Typography.Text>
            ...
            <section id="feedback" class="scroll-mt-4 space-y-4">
              ...
              <Card title="Status center">
                ...
                <div class="flex flex-wrap gap-3">
                  ...
                  <Button onClick={() => notification.success({ message: 'Deployment complete', description: 'Version 0.2.1 is ready to publish.' })}>Notification</Button>
