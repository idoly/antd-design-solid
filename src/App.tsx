          ...
          <div class="mx-auto max-w-7xl space-y-8">
            ...
            <section id="overview" class="scroll-mt-4 space-y-4">
              ...
              <div class="grid border-y border-border-secondary bg-surface sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div class="border-b border-border-secondary p-5 lg:border-b-0 lg:border-r"><Statistic title="Automated tests" value={280} suffix="passing" /></div>
              ...
              <div class="grid gap-5 lg:grid-cols-3">
                ...
                <Card title="Release code">
                  <div class="flex flex-col items-center gap-3">
                    <QRCode type="svg" value="https://example.com/releases/0.2.3" />
                    <Typography.Text copyable>release/0.2.3</Typography.Text>
            ...
            <section id="feedback" class="scroll-mt-4 space-y-4">
              ...
              <Card title="Status center">
                ...
                <div class="flex flex-wrap gap-3">
                  ...
                  <Button onClick={() => notification.success({ message: 'Deployment complete', description: 'Version 0.2.3 is ready to publish.' })}>Notification</Button>
