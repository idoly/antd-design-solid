...
const locale: Locale = {
  ...
  "Form": {
    ...
    "defaultValidateMessages": {
      ...
      "types": {
        "string": "${label} അസാധുവായ ${type} ആണ്",
        "method": "${label} അസാധുവായ ${type} ആണ്",
        "array": "${label} അസാധുവായ ${type} ആണ്",
        "object": "${label} അസാധുവായ ${type} ആണ്",
        "number": "${label} അസാധുവായ ${type} ആണ്",
        "date": "${label} അസാധുവായ ${type} ആണ്",
        "boolean": "${label} അസാധുവായ ${type} ആണ്",
        "integer": "${label} അസാധുവായ ${type} ആണ്",
        "float": "${label} അസാധുവായ ${type} ആണ്",
        "regexp": "${label} അസാധുവായ ${type} ആണ്",
        "email": "${label} അസാധുവായ ${type} ആണ്",
        "url": "${label} അസാധുവായ ${type} ആണ്",
        "hex": "${label} അസാധുവായ ${type} ആണ്"
      },
      "string": {
