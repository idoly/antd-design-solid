...
const locale: Locale = {
  ...
  "Form": {
    ...
    "defaultValidateMessages": {
      ...
      "types": {
        "string": "${label} यो एक मान्य ${type} होइन",
        "method": "${label} यो एक मान्य ${type} होइन",
        "array": "${label} यो एक मान्य ${type} होइन",
        "object": "${label} यो एक मान्य ${type} होइन",
        "number": "${label} यो एक मान्य ${type} होइन",
        "date": "${label} यो एक मान्य ${type} होइन",
        "boolean": "${label} यो एक मान्य ${type} होइन",
        "integer": "${label} यो एक मान्य ${type} होइन",
        "float": "${label} यो एक मान्य ${type} होइन",
        "regexp": "${label} यो एक मान्य ${type} होइन",
        "email": "${label} यो एक मान्य ${type} होइन",
        "url": "${label} यो एक मान्य ${type} होइन",
        "hex": "${label} यो एक मान्य ${type} होइन"
      },
      "string": {
