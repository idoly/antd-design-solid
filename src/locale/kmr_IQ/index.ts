...
const locale: Locale = {
  ...
  "Form": {
    ...
    "defaultValidateMessages": {
      ...
      "types": {
        "string": "${label} ne ${type}-a derbasdar e",
        "method": "${label} ne ${type}-a derbasdar e",
        "array": "${label} ne ${type}-a derbasdar e",
        "object": "${label} ne ${type}-a derbasdar e",
        "number": "${label} ne ${type}-a derbasdar e",
        "date": "${label} ne ${type}-a derbasdar e",
        "boolean": "${label} ne ${type}-a derbasdar e",
        "integer": "${label} ne ${type}-a derbasdar e",
        "float": "${label} ne ${type}-a derbasdar e",
        "regexp": "${label} ne ${type}-a derbasdar e",
        "email": "${label} ne ${type}-a derbasdar e",
        "url": "${label} ne ${type}-a derbasdar e",
        "hex": "${label} ne ${type}-a derbasdar e"
      },
      "string": {
