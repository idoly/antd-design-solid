...
const locale: Locale = {
  ...
  "Form": {
    ...
    "defaultValidateMessages": {
      ...
      "types": {
        "string": "${label} টি সঠিক ${type} নয়।",
        "method": "${label} টি সঠিক ${type} নয়।",
        "array": "${label} টি সঠিক ${type} নয়।",
        "object": "${label} টি সঠিক ${type} নয়।",
        "number": "${label} টি সঠিক ${type} নয়।",
        "date": "${label} টি সঠিক ${type} নয়।",
        "boolean": "${label} টি সঠিক ${type} নয়।",
        "integer": "${label} টি সঠিক ${type} নয়।",
        "float": "${label} টি সঠিক ${type} নয়।",
        "regexp": "${label} টি সঠিক ${type} নয়।",
        "email": "${label} টি সঠিক ${type} নয়।",
        "url": "${label} টি সঠিক ${type} নয়।",
        "hex": "${label} টি সঠিক ${type} নয়।"
      },
      "string": {
