...
const locale: Locale = {
  ...
  "Form": {
    ...
    "defaultValidateMessages": {
      ...
      "types": {
        "string": "${label} သည် တရားဝင် ${type} မဟုတ်ပါ",
        "method": "${label} သည် တရားဝင် ${type} မဟုတ်ပါ",
        "array": "${label} သည် တရားဝင် ${type} မဟုတ်ပါ",
        "object": "${label} သည် တရားဝင် ${type} မဟုတ်ပါ",
        "number": "${label} သည် တရားဝင် ${type} မဟုတ်ပါ",
        "date": "${label} သည် တရားဝင် ${type} မဟုတ်ပါ",
        "boolean": "${label} သည် တရားဝင် ${type} မဟုတ်ပါ",
        "integer": "${label} သည် တရားဝင် ${type} မဟုတ်ပါ",
        "float": "${label} သည် တရားဝင် ${type} မဟုတ်ပါ",
        "regexp": "${label} သည် တရားဝင် ${type} မဟုတ်ပါ",
        "email": "${label} သည် တရားဝင် ${type} မဟုတ်ပါ",
        "url": "${label} သည် တရားဝင် ${type} မဟုတ်ပါ",
        "hex": "${label} သည် တရားဝင် ${type} မဟုတ်ပါ"
      },
      "string": {
