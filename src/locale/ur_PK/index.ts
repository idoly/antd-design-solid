...
const locale: Locale = {
  ...
  "Form": {
    ...
    "defaultValidateMessages": {
      ...
      "types": {
        "string": "${label} درست نہیں ہے ${type}",
        "method": "${label} درست نہیں ہے ${type}",
        "array": "${label} درست نہیں ہے ${type}",
        "object": "${label} درست نہیں ہے ${type}",
        "number": "${label} درست نہیں ہے ${type}",
        "date": "${label} درست نہیں ہے ${type}",
        "boolean": "${label} درست نہیں ہے ${type}",
        "integer": "${label} درست نہیں ہے ${type}",
        "float": "${label} درست نہیں ہے ${type}",
        "regexp": "${label} درست نہیں ہے ${type}",
        "email": "${label} درست نہیں ہے ${type}",
        "url": "${label} درست نہیں ہے ${type}",
        "hex": "${label} درست نہیں ہے ${type}"
      },
      "string": {
